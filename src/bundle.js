...
module.exports = exports['default'];
},{"../utils/mapValues":167}],164:[function(require,module,exports){
(function (process){
'use strict';
...
},{"../createStore":160,"../utils/isPlainObject":166,"../utils/mapValues":167,"../utils/pick":168,"_process":1}],165:[function(require,module,exports){
/**
...
var _recentPins = require('./recent-pins');

var _recentPins2 = _interopRequireDefault(_recentPins);
    ...
    _createClass(App, [{
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                'div',
                { className: 'row' },
                _react2.default.createElement(_mapView2.default, { store: this.props.store }),
                _react2.default.createElement(_recentPins2.default, { store: this.props.store })
            );
        }
    }]);
...
},{"./map-view":170,"./recent-pins":172,"react":159}],170:[function(require,module,exports){
'use strict';
    ...
    _createClass(MapView, [{
        ...
        value: function componentDidMount() {
            ...
            this.map.addListener('rightclick', function (e) {
                ...
                _this2.props.store.dispatch({ type: 'ADD_PIN', data: {
                        lat: e.latLng.lat(),
                        lng: e.latLng.lng(),
                        user: 'Test user',
...
var RecentPinItem = (function (_Component) {
    _inherits(RecentPinItem, _Component);

    function RecentPinItem() {
        _classCallCheck(this, RecentPinItem);

        return _possibleConstructorReturn(this, Object.getPrototypeOf(RecentPinItem).apply(this, arguments));
    }

    _createClass(RecentPinItem, [{
        key: "render",
        value: function render() {

            return _react2.default.createElement(
                "div",
                { className: "recent-pin-item" },
    ...
    return RecentPinItem;
})(_react.Component);

exports.default = RecentPinItem;
...
var _recentPinItem = require('./recent-pin-item');

var _recentPinItem2 = _interopRequireDefault(_recentPinItem);
...
var RecentPins = (function (_Component) {
    _inherits(RecentPins, _Component);

    function RecentPins() {
        _classCallCheck(this, RecentPins);

        return _possibleConstructorReturn(this, Object.getPrototypeOf(RecentPins).apply(this, arguments));
    }

    _createClass(RecentPins, [{
        key: 'render',
        value: function render() {

            var pins = this.props.store.getState().pins;
            var pinNodes = [];

            for (var i in pins) {
                pinNodes.push(_react2.default.createElement(_recentPinItem2.default, { key: i, pin: pins[i] }));
            }
...
exports.default = RecentPins;

},{"./recent-pin-item":171,"react":159}],173:[function(require,module,exports){
'use strict';
...
var pinRef = new _firebase2.default('https://glowing-torch-7828.firebaseio.com/pins');
...
var store = (0, _redux.createStore)(function () {
    var state = arguments.length <= 0 || arguments[0] === undefined ? { pins: [] } : arguments[0];
...
pinRef.on('value', function (snapshot) {

    store.dispatch({ type: 'HYDRATE', data: snapshot.val() });
});

},{"./components/app":169,"firebase":2,"react":159,"react-dom":3,"redux":161}]},{},[170,171,172,173]);
